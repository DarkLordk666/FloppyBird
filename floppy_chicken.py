...
# Load sounds
die_sound = pygame.mixer.Sound('C:\\PG\\Python Project\\FloppyChicken\\assets\\die-101soundboards.mp3')
game_over_sound = pygame.mixer.Sound('C:\\PG\\Python Project\\FloppyChicken\\assets\\SUPER MARIO - game over - sound effect.mp3')
point_sound = pygame.mixer.Sound('C:\\PG\\Python Project\\FloppyChicken\\assets\\point-101soundboards.mp3')
hit_sound = pygame.mixer.Sound('C:\\PG\\Python Project\\FloppyChicken\\assets\\flappy-bird-hit-sound-101soundboards.mp3')
flap_sound = pygame.mixer.Sound('C:\\PG\\Python Project\\FloppyChicken\\assets\\flap-101soundboards.mp3')
pygame.mixer.music.load('C:\\PG\\Python Project\\FloppyChicken\\assets\\Flappy Chicken Groove.mp3')
